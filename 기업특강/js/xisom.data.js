...
(function () {
    ...
    // Define field property for ListViewColumn
    Object.defineProperty(ListViewColumn.prototype, "field", {
        get: function () {
            return this._field;
        }
    });
...
(function () {
    ...
    Object.defineProperty(ListViewItem.prototype, "selected", {
        get: function () {
            var isSelected = false;
            for (var i = 0; i < this.callback.selectedItems.count; i++) {
                if (this.callback.selectedItems[i].id == i + 1) {
                    isSelected = true;
                    break;
                }
            }
        ...
        set: function (value) {
            if (this.selected != value) {
                var checkBox = $("#jqg_" + this.callback.name + "_" + this.id);
                checkBox.click();
            }
        }
    });
