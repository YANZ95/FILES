...
(function () {
	...
	MixedChartView.prototype.setVisible = function (value) {
	...
	MixedChartView.prototype.optionLegend = function () {
		...
		for (var i = 0; i < count; i++) {
			...
			item.selected[series.name] = series.visible;
		}
		return item;
	}
	...
	MixedChartView.prototype.optionYaxis = function () {
		...
		//Min/Max
		var min = isNaN(oYaxis.minValue) ? function (item) {
			var diff = item.max - item.min;
			if (diff == 0) { diff = 1 }
			return (item.min - ((diff) * 0.2)).toFixed(0);
		} : oYaxis.minValue;
		var max = isNaN(oYaxis.maxValue) ? function (item) {
			var diff = item.max - item.min;
			if (diff == 0) { diff = 1 }
	...
	MixedChartView.prototype.optionSeriesByLine = function (series) {
		...
		var stack = this.stacked == "none" ? "" : "total";
	...
	MixedChartView.prototype.dataRefresh = function () {
		if (typeof this.refreshHandle == "undefined") {
			this.refreshHandle = 0;
		} else {
			clearTimeout(this.refreshHandle);
		}
		var chart = this;
		this.refreshHandle = setTimeout(function () {
			chart.drawChart();
		}, 1);
	}
...
(function () {
	...
	ScatterPlotView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	BarChartView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	PieChartView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	DoughnutChartView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	PyramidChartView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	RadarChartView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
...
(function () {
	...
	BoxPlotView.prototype.setVisible = function (value) {
        var visibility = value == true ? "visible" : "hidden";
