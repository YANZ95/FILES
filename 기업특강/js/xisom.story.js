    ...
    function addRotationSpeed(view, effect) {
        ...
        var e = {
            ...
            getAngle: function () {
                ...
                var value = effect.tag.value;
                var span = (time - this.baseTime) / 1000.0;
                var angle = ((this.baseValue * effect.scaleFactor + effect.scaleOffset) * span + this.baseAngle) % 360.0;
