...
ChartElement.prototype.optionLegendPosition = function (position) {
    ...
    else if (position == "TopLeft") return {
        left: 'left',
        top: 'top',
        right: 'auto',
        bottom: 'auto'
    };
    else if (position == "TopRight") return {
        left: 'right',
        top: 'top',
        right: 'auto',
        bottom: 'auto'
    ...
    else if (position == "BottomLeft") return {
        left: 'left',
        top: 'auto',
        right: 'auto',
        bottom: 'bottom'
    };
    else if (position == "BottomRight") return {
        left: 'right',
        top: 'auto',
        right: 'auto',
        bottom: 'bottom'
